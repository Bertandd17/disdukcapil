...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (window.AdminVerificationConfirm) {
        window.AdminVerificationConfirm.bindAcceptButton({
            ...
            loadingHtml: '<div class="flex flex-col items-center gap-3 py-2"><i class="fas fa-circle-notch fa-spin text-4xl text-green-500"></i><p class="text-gray-600 text-sm">Sedang memproses data KK...</p></div>'
        });
    }

    if (btnTolak && window.AdminVerificationConfirm) {
        window.AdminVerificationConfirm.bindRejectButton({
            loadingHtml: '<div class="flex flex-col items-center gap-3 py-2"><i class="fas fa-circle-notch fa-spin text-4xl text-red-500"></i><p class="text-gray-600 text-sm">Sedang memproses penolakan permohonan KK...</p></div>'
        });
    }
});
</script>
