...
<div class="grid lg:grid-cols-3 gap-6 mb-6">
    ...
    <div class="bg-white rounded-xl border border-gray-100 p-6 shadow-sm reveal">
        ...
        <div class="space-y-3">
            <a href="{{ route('admin.antrian-online') }}" class="flex items-center gap-3 p-3 rounded-lg border border-gray-200 hover:border-gray-400 hover:bg-gray-50 transition group">
                <div class="w-10 h-10 bg-gray-100 rounded-lg flex items-center justify-center group-hover:bg-gray-200 transition">
                    <i class="fas fa-ticket-alt text-gray-600 group-hover:text-gray-700 transition"></i>
                </div>
                <div class="flex-1">
            ...
            <a href="{{ route('admin.berita') }}" class="flex items-center gap-3 p-3 rounded-lg border border-gray-200 hover:border-gray-400 hover:bg-gray-50 transition group">
                <div class="w-10 h-10 bg-gray-100 rounded-lg flex items-center justify-center group-hover:bg-gray-200 transition">
                    <i class="fas fa-newspaper text-gray-600 group-hover:text-gray-700 transition"></i>
                </div>
                <div class="flex-1">
            ...
            <a href="{{ route('admin.manajemen-akun') }}" class="flex items-center gap-3 p-3 rounded-lg border border-gray-200 hover:border-gray-400 hover:bg-gray-50 transition group">
                <div class="w-10 h-10 bg-gray-100 rounded-lg flex items-center justify-center group-hover:bg-gray-200 transition">
                    <i class="fas fa-users-cog text-gray-600 group-hover:text-gray-700 transition"></i>
                </div>
                <div class="flex-1">
            ...
            <a href="{{ route('admin.visualisasi-data') }}" class="flex items-center gap-3 p-3 rounded-lg border border-gray-200 hover:border-gray-400 hover:bg-gray-50 transition group">
                <div class="w-10 h-10 bg-gray-100 rounded-lg flex items-center justify-center group-hover:bg-gray-200 transition">
                    <i class="fas fa-chart-line text-gray-600 group-hover:text-gray-700 transition"></i>
                </div>
                <div class="flex-1">
            ...
            <a href="{{ route('admin.penerbitan-kk') }}" class="flex items-center gap-3 p-3 rounded-lg border border-gray-200 hover:border-gray-400 hover:bg-gray-50 transition group">
                <div class="w-10 h-10 bg-gray-100 rounded-lg flex items-center justify-center group-hover:bg-gray-200 transition">
                    <i class="fas fa-file-export text-gray-600 group-hover:text-gray-700 transition"></i>
                </div>
                <div class="flex-1">
