...
@include('components.page-loading')
    ...
    <div class="relative z-10 error-page__container w-full mx-auto">
        ...
        <div class="text-center error-page__hero">
            ...
            <h1 class="error-page__code font-black text-white mb-2 sm:mb-3 animate-bounce-slow">404</h1>
            <p class="text-lg sm:text-xl md:text-2xl font-bold text-white mb-1 sm:mb-2">Halaman Tidak Ditemukan</p>
            <p class="text-blue-100 text-sm sm:text-base px-2">Maaf, halaman yang Anda cari tidak dapat ditemukan.</p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-2xl error-page__card">
            <div class="text-center error-page__card-inner mb-4 sm:mb-6">
                ...
                <h3 class="text-lg sm:text-xl font-bold text-gray-800 mb-1 sm:mb-2">Apa yang Anda Cari?</h3>
                <p class="text-sm sm:text-base text-gray-600 mb-0">Halaman yang Anda minta tidak tersedia atau telah dipindahkan.</p>
            </div>
            ...
            <div class="flex flex-col error-page__tips-wrap error-page__tips mb-4 sm:mb-6">
                <div class="flex items-start error-page__tip bg-gray-50 rounded-xl hover:bg-blue-50 transition">
                    ...
                    <div class="min-w-0">
                        <p class="font-semibold text-gray-800 text-sm sm:text-base">Periksa URL</p>
                        <p class="text-xs sm:text-sm text-gray-600">Pastikan alamat URL yang Anda masukkan sudah benar.</p>
                    </div>
                </div>
                ...
                <div class="group flex items-start error-page__tip bg-gray-50 rounded-xl hover:bg-blue-50 transition">
                    ...
                    <div class="min-w-0">
                        ...
                        <p class="text-xs sm:text-sm text-gray-600">Halaman mungkin telah dipindahkan ke lokasi lain.</p>
                    </div>
                </div>
                ...
                <div class="flex items-start error-page__tip bg-gray-50 rounded-xl hover:bg-blue-50 transition">
                    ...
                    <div class="min-w-0">
                        <p class="font-semibold text-gray-800 text-sm sm:text-base">Halaman Kadaluarsa</p>
                        <p class="text-xs sm:text-sm text-gray-600">Halaman yang Anda cari mungkin sudah tidak tersedia lagi.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="flex flex-col sm:flex-row error-page__actions">
                <a href="{{ url()->previous() }}" class="error-page__btn flex-1 bg-gray-200 text-gray-800 rounded-xl font-bold hover:bg-gray-300 transition-all shadow-md flex items-center justify-center gap-2">
                    <i class="fas fa-arrow-left"></i>
                    Kembali
                </a>
                <a href="{{ route('home') }}" class="error-page__btn flex-1 bg-blue-600 text-white rounded-xl font-bold hover:bg-blue-700 transition-all shadow-lg flex items-center justify-center gap-2">
        ...
        <div class="text-center text-blue-100 text-xs sm:text-sm px-2">
            ...
            <p class="text-blue-200 mt-1">Hubungi kami jika masalah berlanjut</p>
        </div>
    </div>
