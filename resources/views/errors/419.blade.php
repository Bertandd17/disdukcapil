...
@include('components.page-loading')
    ...
    <div class="error-wrapper">
        ...
        <p class="error-title">Halaman Kadaluarsa</p>
        <p class="error-desc">Maaf, halaman yang Anda minta sudah tidak berlaku.</p>

        <div class="error-card">
            <div style="text-align: center; margin-bottom: var(--spacing-lg);">
                <div class="action-icon" style="background: #FEF3C7; margin: 0 auto var(--spacing-md); width: 56px; height: 56px;">
                    <i class="fas fa-hourglass-half" style="color: #D97706; font-size: 1.5rem;"></i>
                </div>
                <h3 style="font-size: 1.25rem; font-weight: 700; color: #1f2937; margin-bottom: var(--spacing-xs);">Sesi Telah Berakhir</h3>
                <p style="font-size: var(--font-size-sm); color: #4b5563;">Halaman yang Anda minta sudah kedaluwarsa. Silakan refresh halaman dan coba lagi.</p>
            </div>
            ...
            <div class="action-list-item">
                ...
                <div class="action-text">
                    ...
                    <p style="font-size: var(--font-size-sm); color: #4b5563; margin: 0;">Coba refresh halaman ini dengan menekan F5 atau tombol refresh browser.</p>
                </div>
            </div>
            ...
            <div class="action-list-item">
                ...
                <div class="action-text">
                    ...
                    <p style="font-size: var(--font-size-sm); color: #4b5563; margin: 0;">Kembali ke halaman utama dan mulai dari awal.</p>
                </div>
            </div>
            ...
            <div class="action-list-item" style="margin-bottom: 0;">
                ...
                <div class="action-text">
                    <p style="font-weight: 600; color: #1f2937; margin: 0;">Ulangi Aksi</p>
                    <p style="font-size: var(--font-size-sm); color: #4b5563; margin: 0;">Jika Anda baru saja mengirim formulir, tunggu sebentar lalu refresh.</p>
                </div>
            </div>
        ...
        <div class="error-footer">
            ...
            <p style="margin-top: 0.25rem;">Jika masalah berlanjut, silakan hubungi admin</p>
        </div>
    </div>
